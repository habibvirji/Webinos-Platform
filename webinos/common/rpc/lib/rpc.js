...
//				}
	...
	_RPCHandler.prototype.findServices = function (serviceType, callback, options, filter) {
		...
		if(cstar !== -1){
			...
			var entityRefCount = this.parent.pzhId ? 1 : 0;
			entityRefCount += this.parent.connectedPeer ? Object.keys(this.parent.connectedPeer).length : 0;
			...
			if (this.parent.connectedPeer && Object.keys(this.parent.connectedPeer).length > 0) {
